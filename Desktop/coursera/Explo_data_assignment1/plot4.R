...
png('plot4.png', width = 480, height = 480)  # plotting data
...
with(subsetdata, plot(FullTimeDate, Global_reactive_power, type = "l",xlab = "datetime", ylab = "Global_rective_power"))
dev.off()